...
use App\Http\Requests\Subjects\CreateSubject;
...
class SubjectsController extends Controller
{
     ...
     */
    public function store(CreateSubject $request) : JsonResponse
    {
     ...
     */
    public function update(UpdateSubject $request, string $id) : JsonResponse
    {
